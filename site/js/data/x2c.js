...
(function () {
  ...
  const g41e = [
    ...
    (r) => {
      ...
      return { q: T(`True or false? "${se}" Give a reason.`, `Benar atau palsu? "${sm}" Berikan satu sebab.`), a: T(`${tv ? 'True' : 'False'}. ${re}`, `${tv ? 'Benar' : 'Palsu'}. ${rm2}`), w: W(T(we, wm), T(`So the statement is ${tv ? 'true' : 'false'}.`, `Maka pernyataan itu ${tv ? 'benar' : 'palsu'}.`)), sp: 's' };
    },
    (r) => {
  ...
  const g41ba = [
    ...
    (r) => {
      ...
      return { q: T(`Decide whether the statement is true or false, and justify your answer: "${se}"`, `Tentukan sama ada pernyataan itu benar atau palsu, dan justifikasikan jawapan anda: "${sm}"`), a: T(`${tv ? 'True' : 'False'}. ${re}`, `${tv ? 'Benar' : 'Palsu'}. ${rm2}`), w: W(T(we, wm), T(`So the statement is ${tv ? 'true' : 'false'}.`, `Maka pernyataan itu ${tv ? 'benar' : 'palsu'}.`)), sp: 'm' };
    },
    (r) => {
  ...
  const g42e = [
    ...
    (r) => {
      ...
      return { q: T(`True or false? "${tf[0]}" Give a reason.`, `Benar atau palsu? "${tf[1]}" Berikan satu sebab.`), a: T(`${tf[2] ? 'True' : 'False'}. ${tf[3]}`, `${tf[2] ? 'Benar' : 'Palsu'}. ${tf[4]}`), w: W(T(`Interior sum $= (n - 2) \\times 180^\\circ$; exterior sum $= 360^\\circ$ always.`, `Hasil tambah pedalaman $= (n - 2) \\times 180^\\circ$; hasil tambah peluaran $= 360^\\circ$ sentiasa.`), T(tf[3], tf[4]), T(`So the statement is ${tf[2] ? 'true' : 'false'}.`, `Maka pernyataan itu ${tf[2] ? 'benar' : 'palsu'}.`)), sp: 's' };
    },
    (r) => {
  ...
  const g51e = [
    ...
    (r) => {
      ...
      return { q: T(`True or false? "${se}" Explain.`, `Benar atau palsu? "${sm}" Terangkan.`), a: T(`${tv ? 'True' : 'False'}. ${re}`, `${tv ? 'Benar' : 'Palsu'}. ${rm2}`), w: W(T(`Check the statement against the definitions: $d = 2r$, a chord joins two points on the circle, a sector is bounded by two radii and an arc, and a segment by a chord and an arc.`, `Semak pernyataan itu dengan takrifan: $d = 2r$, perentas menyambung dua titik pada bulatan, sektor dibatasi oleh dua jejari dan satu lengkok, dan tembereng oleh satu perentas dan satu lengkok.`), T(re, rm2), T(`So the statement is ${tv ? 'true' : 'false'}.`, `Maka pernyataan itu ${tv ? 'benar' : 'palsu'}.`)), sp: 's' };
    },
    (r) => {
  ...
  const g53e = [
    ...
    (r) => {
      ...
      return { q: T(`True or false? "${se}" Explain.`, `Benar atau palsu? "${sm}" Terangkan.`), a: T(`${tv ? 'True' : 'False'}. ${re}`, `${tv ? 'Benar' : 'Palsu'}. ${rm2}`), w: W(T(`Use $C = 2\\pi r = \\pi d$ and $A = \\pi r^2$: the circumference is proportional to $r$, but the area is proportional to $r^2$.`, `Guna $C = 2\\pi r = \\pi d$ dan $A = \\pi r^2$: lilitan berkadar terus dengan $r$, tetapi luas berkadar dengan $r^2$.`), T(re, rm2), T(`So the statement is ${tv ? 'true' : 'false'}.`, `Maka pernyataan itu ${tv ? 'benar' : 'palsu'}.`)), sp: 's' };
    },
    (r) => {
